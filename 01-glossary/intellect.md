...
INTELLECT (MIND; INTELLIGENCE). The power of understanding and reasoning. Many speak well but understand poorly ([[chapter-14-tj-way-ccel|14.2]]). Many are unable to reason with the intellect in prayer ([[chapter-19-tj-way-ccel|19.1]]). Some minds can concentrate and work methodically; others are scattered ([[chapter-19-tj-way-ccel|19.1]]–[[chapter-19-tj-way-ccel|2]]; [[chapter-30-tj-way-ccel|30.7]]). The prayer of recollection helps the intellect to be recollected ([[chapter-28-tj-way-ccel|28.4]]). In contemplation, in a way very different from the way it understands through the exterior senses, the soul understands that it is close to its God ([[chapter-31-tj-way-ccel|31.2]]).
